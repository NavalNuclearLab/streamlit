...
class UtilTest(unittest.TestCase):
    def test_sha256_calculation_succeeds_with_bytes_input(self):
        with patch("streamlit.watcher.util.open", mock_open(read_data=b"hello")) as m:
            sha256 = util.calc_sha256_with_blocking_retries("foo")
            self.assertEqual(sha256, "5d41402abc4b2a76b9719d911017c592")

    def test_sha256_calculation_opens_file_with_rb(self):
